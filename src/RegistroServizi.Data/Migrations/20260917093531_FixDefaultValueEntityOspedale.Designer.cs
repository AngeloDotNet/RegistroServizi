...
namespace RegistroServizi.Data.Migrations
{
    ...
    [Migration("20260917093531_FixDefaultValueEntityOspedale")]
    partial class FixDefaultValueEntityOspedale
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RegistroServizi.Data.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RegistroServizi.Domain.Entities.Ospedale", b =>
                {
                    ...
                    b.Property<string>("NomeOspedale")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.ComplexProperty(typeof(Dictionary<string, object>), "Coordinate", "RegistroServizi.Domain.Entities.Ospedale.Coordinate#Coordinate", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.HasIndex("NomeOspedale")
                        .IsUnique();

                    b.ToTable("Ospedali", (string)null);
                });
            ...
            modelBuilder.Entity("RegistroServizi.Domain.Entities.StatoBolla", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("StatiBolla", (string)null);
                });
            ...
            modelBuilder.Entity("RegistroServizi.Domain.Entities.TitoloStudio", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TitoliStudio", (string)null);
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RegistroServizi.Data.Identity.ApplicationUser", null)
                        .WithMany()
